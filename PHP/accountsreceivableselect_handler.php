<?php
// PHP/accountsreceivableselect_handler.php - MODIFIED to use connectDB()
header('Content-Type: application/json');

// Include the connection handler file
...
try {
    ...
    // This catch block handles any PDOExceptions not caught within connectDB(), though
    // connectDB() handles connection errors itself by exiting.
    // We keep it for safety in case of query execution errors.
