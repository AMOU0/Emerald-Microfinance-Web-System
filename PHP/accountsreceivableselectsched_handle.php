...
try {
    // Use the connectDB function from aadb_connect_handler.php
    $pdo = connectDB();
    ...
    // The connectDB function already handles a connection failure with an exit.
    // This catch block handles other database errors (e.g., query execution).
